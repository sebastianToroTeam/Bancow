...
public class Correo implements Serializable {
    ...
    public static final String ENTIDAD_CORREO_PK = "id";
    public static final String ENTIDAD_CORREO_MAIL = "mail";
    ...
    private static final String[] ATRIBUTOS_ENTIDAD_CORREO
            = {ENTIDAD_CORREO_PK, ENTIDAD_CORREO_MAIL, ENTIDAD_CORREO_ESTADO, ENTIDAD_CORREO_FUNCIONARIO_NUMERO_ID};
    ...
    /**
     * Valida la igualdad de la instancia de la entidad Correo que se pasa como
